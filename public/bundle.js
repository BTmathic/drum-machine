...
var _DrumMachine = __webpack_require__(27);
...
_reactDom2.default.render(_react2.default.createElement(_DrumMachine2.default, null), document.getElementById('app')); // reset all browser conventions
...
var _reactRangeslider = __webpack_require__(28);

var _reactRangeslider2 = _interopRequireDefault(_reactRangeslider);

var _DrumPads = __webpack_require__(37);

var _DrumPads2 = _interopRequireDefault(_DrumPads);

var _drumPads = __webpack_require__(39);
...
var DrumMachine = function (_React$Component) {
  ...
  function DrumMachine() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DrumMachine.__proto__ || Object.getPrototypeOf(DrumMachine)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      on: true,
      volume: 80
    }, _this.handleChange = function (volume) {
      _this.setState(function () {
        return { volume: volume };
      });
    }, _this.togglePower = function () {
  ...
  _createClass(DrumMachine, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { id: 'drum-machine' },
        _react2.default.createElement(_DrumPads2.default, { on: this.state.on, pads: _drumPads2.default, volume: this.state.volume }),
        _react2.default.createElement(
          'div',
          { id: 'power-button', onClick: function onClick() {
              _this2.togglePower();
            } },
          'Power'
        ),
...
var _Rangeslider = __webpack_require__(29);
...
var _DrumPad = __webpack_require__(38);

var _DrumPad2 = _interopRequireDefault(_DrumPad);
...
var DrumPads = function DrumPads(props) {
  return _react2.default.createElement(
    'div',
    { id: 'drum-pads' },
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[0], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[1], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[2], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[3], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[4], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[5], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[6], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[7], volume: props.volume }),
    _react2.default.createElement(_DrumPad2.default, { on: props.on, audio: props.pads[8], volume: props.volume })
  );
};

exports.default = DrumPads;
...
var DrumPad = function (_React$Component) {
  ...
  function DrumPad() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DrumPad.__proto__ || Object.getPrototypeOf(DrumPad)).call.apply(_ref, [this].concat(args))), _this), _this.play = function () {
      if (_this.props.on) {
        _this.refs.audio.volume = _this.props.volume / 100;
        _this.refs.audio.play();
      }
    }, _this.handleKeyPress = function (e) {
      e.preventDefault(); // Probably not necessary, but just in case
      var keyName = e.key;
      if (keyName === _this.props.audio.keyTrigger) {
        _this.play();
      }
  ...
  _createClass(DrumPad, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'drum-pad', id: 'audio-clip-description', onClick: function onClick() {
            _this2.play(_this2.refs);
          } },
        _react2.default.createElement(
          'audio',
          { className: 'clip',
